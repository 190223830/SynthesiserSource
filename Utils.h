...
public:
    ...
    GenericSlider(juce::String labelName, juce::String parameter, juce::AudioProcessorValueTreeState& apvts, SliderStyle style = SliderStyle::RotaryHorizontalVerticalDrag);
